        ...
        return (
          <div>
            ...
            <section className={styles.section}>
              ...
              <p>
                Casa de Cambios Insular, S.A. pone a disposición de sus clientes un asistente virtual automatizado
              ...
              <ul>
                ...
                <li>Casa de Cambios Insular, S.A. no se responsabiliza por decisiones tomadas exclusivamente con base en información del Chatbot</li>
              </ul>
              ...
              <p>
                Casa de Cambios Insular, S.A. no será responsable, en la máxima medida permitida por la ley, por:
              </p>
              <ul>
              ...
              <ul>
                ...
                <li>Respetar los derechos de propiedad intelectual de Casa de Cambios Insular, S.A.</li>
              ...
              <p>
                <strong>Canales oficiales de confirmación:</strong> WhatsApp/Teléfono +58 414-2093083, Email operaciones@insular.io,
              ...
              <ul>
                ...
                <li>Casa de Cambios Insular, S.A. se reserva el derecho de modificar, suspender o descontinuar el servicio sin previo aviso</li>
      ...
      case 'lcft':
        return (
          <div>
            ...
            <section className={styles.section}>
              <p>
                En Casa de Cambios Insular, S.A; tu seguridad es nuestra prioridad. Por ello, la prevención y el control contra la legitimación de capitales, el financiamiento al terrorismo y el financiamiento de la proliferación de armas de destrucción masiva son de suma importancia para nosotros.
              </p>
              <p>
            ...
            <section className={styles.section}>
              ...
              <p>
                Casa de Cambios Insular, S.A; cuenta con una estructura eficiente para administrar de forma integral los Riesgos de Legitimación de Capitales, el Financiamiento al Terrorismo y Proliferación de Armas de Destrucción Masiva (LC/FT/FPADM).
              </p>
              <p>
  ...
  return (
    <>
      <SEO
        ...
        description="Política de cookies, privacidad (LOPD), términos y condiciones y prevención LC/FT/FPADM de Insular Casa de Cambio. Transparencia y cumplimiento normativo."
        keywords="política privacidad, términos condiciones, cookies, LOPD, prevención lavado dinero, casa de cambio legal"
        canonical="/legal"
        ogImage="/images/og/insular-legal.jpg"
        ogImageAlt="Información Legal - Insular Casa de Cambio"
      />
