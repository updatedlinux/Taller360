...
const DomainVerificationModal = () => {
  ...
  useEffect(() => {
    ...
    const domainAccepted = getCookie('taller360_domain_accepted');
  ...
  const handleAccept = () => {
    ...
    setCookie('taller360_domain_accepted', 'true', 30);
    setHasAccepted(true);
    setIsOpen(false);
  };
  ...
  return createPortal(
    ...
    >
      <div className={styles.content}>
        <p>
          Por tu seguridad, verifica que estás en el sitio oficial de <strong>Taller360</strong>
        </p>
