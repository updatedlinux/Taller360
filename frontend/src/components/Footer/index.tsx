      ...
      <div className="container-full">
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerBrand}>
            <Link to="/" className={styles.brandLink} aria-label="Volver al inicio">
              <img src={withBase('logos/taller360-logo.svg')} alt="Taller360" className={styles.brandLogo} loading="lazy" />
            </Link>
          </div>
          ...
          <div className={styles.menuColumnsWrapper}>
            ...
            <div className={styles.footerColumn}>
              <ul className={styles.footerLinks}>
                ...
                <li><a href="mailto:info@taller360.local">info@taller360.local</a></li>
        ...
        <div className={styles.footerBottom}>
          ...
          <div className={styles.footerBottomRight}>
            ...
            <span className={styles.handle}>@taller360</span>
          </div>
        </div>
