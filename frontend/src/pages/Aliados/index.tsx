...
const Aliados = () => {
  ...
  const partners = [
    ...
    },
    {
      ...
      outro: 'Papaya le permite a los clientes de Taller360 una alternativa a los servicios de transferencias tradicionales, facilitando los pagos de manera rápida y con un bajo costo entre usuarios de diferentes regiones.'
    },
    {
      id: 'tsg',
      name: 'TSG',
  ...
  return (
    <>
      <SEO
        ...
        keywords="aliados Taller360, B89, Papaya, TSG, Panamericash, remesas internacionales, partners, socios"
        canonical="/aliados"
        ogImage="/images/og/insular-aliados.jpg"
        ogImageAlt="Aliados Internacionales - Taller360"
      />
