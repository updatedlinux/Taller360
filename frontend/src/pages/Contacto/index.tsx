...
const Contacto = () => {
  ...
  return (
    <>
      <SEO
        title="Contacto"
        description="Contáctanos para resolver todas tus dudas sobre cambio de divisas y remesas. WhatsApp +58 414-2093083, email operaciones@taller360.local. Estamos aquí para ayudarte."
        keywords="contacto Taller360, casa de cambio contacto, teléfono, whatsapp, email, dirección Caracas, horarios"
        canonical="/contacto"
        ogImage="/images/og/insular-contacto.jpg"
        ogImageAlt="Contacto - Taller360 Venezuela"
      />
          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroRight}>
              ...
              <div className={styles.infoCard}>
                ...
                <div className={styles.cardValue}>
                  <a href="mailto:operaciones@taller360.local">operaciones@taller360.local</a>
                </div>
                <div className={styles.cardIcon}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 17L17 7M17 7H7M17 7V17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
