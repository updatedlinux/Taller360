...
const Conocenos = () => {
  ...
  return (
    <>
      <SEO
        title="Conócenos"
        description="Somos Taller360, tu Casa de Cambio de confianza desde hace más de 35 años. Conoce nuestra misión, visión y valores en el mercado cambiario venezolano."
        keywords="casa de cambio Venezuela, Taller360, historia, misión, visión, valores, cambio de divisas Caracas"
        canonical="/conocenos"
        ogImage="/images/og/insular-conocenos.jpg"
        ogImageAlt="Conócenos - Taller360 Venezuela"
      />
        ...
        <div className="container">
          <div className={styles.heroContent}>
            <div className={styles.heroText} data-animate="fade-up">
              <h1>Somos Taller360 Tu Casa de Cambio de Confianza desde hace más de 35 años.</h1>
