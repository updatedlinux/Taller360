...
const Home = () => {
  ...
  return (
    <>
      <SEO
        title="Taller360 - Recibe dinero de otros países"
        ...
        ogImageAlt="Taller360 - Los mejores tipos de cambio en Venezuela"
          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroImageWrapper} data-animate="fade-left">
              <img
                ...
                alt="Cliente feliz usando Taller360"
        ...
        <div className="container">
          <div className={styles.revealText}>
            ...
            <p ref={revealTextRef2} className={styles.revealTextSmall}>
              En Taller360 somos una remesadora autorizada por SUDEBAN, con más de 35 años de trayectoria en el sector cambiario. Conectamos familias con soluciones rápidas, seguras y sin complicaciones.
            </p>
          </div>
        </div>
      </Section>
